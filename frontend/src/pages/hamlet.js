  ...
  const handleClick = useCallback(
    (e) => {
      ...
      socket.send(
        JSON.stringify({
          message:
            "Imagine that you are Hamlet from William Shakespeare's play 'The Tragedy of Hamlet'. Answer the following question only as Hamlet in 200 words or less: " +
            inputValue,
        })
      );
      setLoading(true);
      ...
      >
        ...
        <div className="chat-and-pic">
          <div className="left-side">
            <img src={hamlet} style={{ width: 578, height: 458 }}></img>
